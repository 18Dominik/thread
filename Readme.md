...
```
cd existing_repo
git remote add origin https://git.dzbank.vrnet/techlab/nodejs/thread.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.dzbank.vrnet/techlab/nodejs/thread/-/settings/integrations)
